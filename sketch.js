...
var cannon_explode,waterSound,pirate_laugh,backgroundMusic;
...
function gameOver() {
 ...
 imageUrl:"https://raw.githubusercontent.com/whithatjr/PirateInvasion/main/assets/boat.png",
 imageSize:"150 * 150",
 confirmButtonText:"try Harder"
  },
  function (isConfirm){
    if(isConfirm){
    location.reload();
